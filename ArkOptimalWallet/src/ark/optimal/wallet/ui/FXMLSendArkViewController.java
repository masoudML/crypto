    ...
    private void onSendArkNext(ActionEvent event) {
        ...
        if(!senderByPassphrase.equals(this.senderAddress))
        {
         ...
         try {
                ...
                Transaction tx = TransactionService.createTransaction(this.senderAddress,destinationAddress.getText(), new Double(amountArk.getText()), smartBridge.getText(), passphrase.getText());
